/**
 * POST /api/futures/liquidation
 *
 * System-wide liquidation sweep — checks ALL open positions across all users.
...
export async function POST(req: Request) {
    ...
    try {
        ...
        // ── Fetch live oracle prices once for all symbols ────────────────────
        ...
        try {
            ...
            // Can't check without prices — bail cleanly
        ...
        // ── Fire liquidations concurrently ───────────────────────────────────
